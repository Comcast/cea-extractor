...
describe("Ides_Of_March.mp4", function() {
    ...
    it("should generate appropriate text", function() {
        ...
        parser.add(fs.readFileSync("tests/Ides_Of_March.mp4").buffer);
        let expected = fs.readFileSync("tests/Ides_Of_March.out").toString();
