...
describe("Encrypted_Wreck_It_Ralph.mp4", function() {
    ...
    it("should generate appropriate text", function() {
        ...
        parser.add(fs.readFileSync("tests/Encrypted_Wreck_It_Ralph.mp4").buffer);
        let expected = fs.readFileSync("tests/Encrypted_Wreck_It_Ralph.out").toString();
